...
<form method="POST" action="{{ route('backend.organizations.store') }}" class="max-w-3xl space-y-4">
    @csrf
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-control">
                    <label class="label py-0 pb-1.5"><span class="label-text font-medium">Slug (URL)</span></label>
                    <input type="text" name="slug" value="{{ old('slug') }}"
                           class="input input-bordered input-sm @error('slug') input-error @enderror"
                           placeholder="tu-dong-tu-ten (để trống = tự tạo)">
