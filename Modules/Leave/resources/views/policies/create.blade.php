...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm chính sách nghỉ phép</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Cấu hình quy tắc nghỉ phép cho tổ chức</p>
    </div>
...
<form method="POST" action="{{ route('backend.leave.policies.store') }}" novalidate data-leave-policy-form>
    @csrf
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            <label class="label py-0 pb-1.5">
                                <span class="label-text font-medium">Hiệu lực từ ngày <span class="text-error">*</span></span>
                            </label>
                            <input type="text" name="effective_from" id="fp-effective-from"
                                   value="{{ old('effective_from', now()->format('Y-m-d')) }}"
                                   data-req="Vui lòng chọn ngày hiệu lực"
                        ...
                        <div class="form-control sm:col-span-2">
                            <label class="flex items-start gap-2.5 cursor-pointer select-none group">
                                ...
                                <input type="checkbox" name="requires_approval" value="1"
                                       ...
                                       {{ old('requires_approval', '1') == '1' ? 'checked' : '' }}>
                                <div>
