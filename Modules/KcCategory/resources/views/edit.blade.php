...
<div class="p-6">
    ...
    <div class="mb-5">
        <h1 class="text-xl font-bold">Chỉnh sửa danh mục</h1>
        <p class="text-sm opacity-60 mt-0.5">{{ $kcCategory->name }}</p>
    </div>
                ...
                <div class="card-body p-5 space-y-4">
                    ...
                    <div class="form-control sm:col-span-2">
                        ...
                        @else
                            <select id="ts-organization" name="organization_id"
                                ...
                                <option value="{{ $org->id }}" {{ old('organization_id', $kcCategory->organization_id) == $org->id ? 'selected' : '' }}>
                                    {{ $org->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-control">
                        ...
                        <input id="name" type="text" name="name"
                               value="{{ old('name', $kcCategory->name) }}"
                    ...
                    <div class="form-control">
                        ...
                        <input id="slug" type="text" name="slug"
                               value="{{ old('slug', $kcCategory->slug) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input id="icon" type="text" name="icon"
                                   value="{{ old('icon', $kcCategory->icon) }}"
                    ...
                    <div class="form-control">
                        ...
                        <input id="sort_order" type="number" name="sort_order"
                               value="{{ old('sort_order', $kcCategory->sort_order) }}"
                               min="0"
                    ...
                    <div class="card-body p-4 space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <label class="flex items-start gap-2.5 cursor-pointer select-none">
                                ...
                                <div>
                                    <span class="text-sm font-medium">Đang hiển thị</span>
                        ...
                        <div class="text-xs text-base-content/40 space-y-1">
                            <p>Tạo: {{ $kcCategory->created_at->format('d/m/Y') }}</p>
                            <p>Cập nhật: {{ $kcCategory->updated_at->diffForHumans() }}</p>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 pt-1 border-t border-base-200">
                            ...
                            <a href="{{ route('backend.kc-categories.show', $kcCategory) }}"
