...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm danh mục mới</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Tạo danh mục tổ chức tài liệu kho tri thức</p>
    </div>
    <a href="{{ route('backend.kc-categories.index') }}" class="btn btn-ghost btn-sm gap-1.5">
            ...
            <div class="card-body space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control">
                        ...
                        <p class="mt-1 text-xs text-base-content/40">VD: ti-folder, ti-book, ti-file-text</p>
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body p-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('backend.kc-categories.index') }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
