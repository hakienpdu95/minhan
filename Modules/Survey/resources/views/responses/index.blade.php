...
#response-table .tabulator { border:none; border-radius:0; background:transparent; font-size:.8125rem; }
#response-table .tabulator-header { background:oklch(var(--b2)); border-bottom:1px solid oklch(var(--b3)); color:oklch(var(--bc)/.65); font-weight:600; font-size:.75rem; text-transform:uppercase; letter-spacing:.04em; }
#response-table .tabulator-col { background:transparent; border-right:1px solid oklch(var(--b3)); }
#response-table .tabulator-col:last-child { border-right:none; }
#response-table .tabulator-col.tabulator-sortable:hover { background:oklch(var(--b3)); }
#response-table .tabulator-row { background:oklch(var(--b1)); border-bottom:1px solid oklch(var(--b2)); }
#response-table .tabulator-row:hover { background:oklch(var(--b2)/.6); }
#response-table .tabulator-row .tabulator-cell { border-right:1px solid oklch(var(--b2)); color:oklch(var(--bc)); padding:.5rem .75rem; }
#response-table .tabulator-row .tabulator-cell:last-child { border-right:none; }
#response-table .tabulator-footer { background:oklch(var(--b2)/.5); border-top:1px solid oklch(var(--b3)); }
#response-table .tabulator-paginator { color:oklch(var(--bc)/.7); }
#response-table .tabulator-page { background:transparent; border:1px solid oklch(var(--b3)); color:oklch(var(--bc)); border-radius:.375rem; padding:.2rem .5rem; margin:0 1px; }
#response-table .tabulator-page:hover:not([disabled]) { background:oklch(var(--b3)); }
#response-table .tabulator-page.active { background:oklch(var(--p)); color:oklch(var(--pc)); border-color:oklch(var(--p)); }
#response-table .tabulator-page[disabled] { opacity:.35; }
#response-table .tabulator-page-size { background:oklch(var(--b1)); border:1px solid oklch(var(--b3)); color:oklch(var(--bc)); border-radius:.375rem; padding:.2rem .4rem; }
#response-table .tabulator-frozen.tabulator-frozen-right { box-shadow:-2px 0 4px oklch(var(--b3)/.5); }
#response-table .tabulator-tableholder::-webkit-scrollbar { width:6px; height:6px; }
#response-table .tabulator-tableholder::-webkit-scrollbar-track { background:oklch(var(--b2)); }
#response-table .tabulator-tableholder::-webkit-scrollbar-thumb { background:oklch(var(--b3)); border-radius:3px; }
#response-table .tabulator-loader { background:oklch(var(--b1)/.7) !important; }
#response-table .tabulator-loader-msg { background:oklch(var(--b2)) !important; border:1px solid oklch(var(--b3)) !important; border-radius:.5rem !important; color:oklch(var(--bc)) !important; }
