...
<form method="POST" action="{{ route('backend.users.update', $user) }}" class="space-y-5">
    @csrf @method('PUT')
    ...
    <div class="card bg-base-100 shadow-sm border border-base-200" x-show="selectedRole" x-transition>
        <div class="card-body">
            ...
            <div class="flex flex-wrap gap-2 mb-4 p-3 bg-base-200/50 rounded-lg">
                ...
                <span class="badge badge-sm badge-success">Full</span>
                <span class="badge badge-sm badge-info">Assigned</span>
                <span class="badge badge-sm badge-warning">Limited</span>
                <span class="badge badge-sm badge-primary">Source view</span>
...
document.addEventListener('alpine:init', function () {
    ...
    var LEVEL_META = {
        ...
        'Use':           { cls: 'badge badge-sm badge-accent',    desc: 'Sử dụng output AI, không cấu hình prompt' },
        'Monitor':       { cls: 'badge badge-sm badge-ghost',     desc: 'Theo dõi trạng thái, không chỉnh sửa' },
        'Monitor/Edit':  { cls: 'badge badge-sm badge-ghost',     desc: 'Theo dõi và chỉnh sửa workflow' },
            ...
            get currentMatrix() {
                ...
                Object.keys(MATRIX).forEach(function (module) {
                    ...
                    if (level) {
                        ...
                        rows.push({ module: module, level: level, badgeClass: meta.cls, desc: meta.desc });
                    }
                });
                return rows;
            },
