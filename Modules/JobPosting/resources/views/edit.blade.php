...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('backend.job-posts.show', $jobPost) }}" class="btn btn-ghost btn-sm gap-1.5">
...
<form method="POST" action="{{ route('backend.job-posts.update', $jobPost) }}" novalidate data-job-post-form>
    @csrf
    @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control sm:col-span-2">
                            ...
                            @else
                                <select id="ts-organization" name="organization_id"
                                    ...
                                    <option value="{{ $org->id }}" {{ old('organization_id', $jobPost->organization_id) == $org->id ? 'selected' : '' }}>
                                        {{ $org->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="title" value="{{ old('title', $jobPost->title) }}"
                                   ...
                                   placeholder="VD: Senior Backend Engineer (PHP / Laravel)"/>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="summary" rows="2"
                                      ...
                                      placeholder="Tóm tắt ngắn hiển thị trên listing card...">{{ old('summary', $jobPost->summary) }}</textarea>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="description"
                                      ...
                                      data-req="Vui lòng nhập mô tả công việc">{{ old('description', $jobPost->description) }}</textarea>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="responsibilities"
                                      ...
                                      data-jodit-preset="standard">{{ old('responsibilities', $jobPost->responsibilities) }}</textarea>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="requirements"
                                      ...
                                      data-req="Vui lòng nhập yêu cầu ứng viên">{{ old('requirements', $jobPost->requirements) }}</textarea>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="nice_to_have"
                                      class="jodit-editor textarea textarea-bordered textarea-sm w-full"
                                      data-jodit-preset="compact">{{ old('nice_to_have', $jobPost->nice_to_have) }}</textarea>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="what_you_will_learn"
                                      class="jodit-editor textarea textarea-bordered textarea-sm w-full"
                                      data-jodit-preset="compact">{{ old('what_you_will_learn', $jobPost->what_you_will_learn) }}</textarea>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="form-control">
                                ...
                                <input type="number" name="min_experience_years" value="{{ old('min_experience_years', $jobPost->min_experience_years) }}"
                            ...
                            <div class="form-control">
                                ...
                                <input type="number" name="max_experience_years" value="{{ old('max_experience_years', $jobPost->max_experience_years) }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="form-control">
                                ...
                                <select id="ts-education-level" name="education_level"
                                    ...
                                    <option value="high_school" {{ old('education_level', $jobPost->education_level) === 'high_school' ? 'selected' : '' }}>THPT</option>
                                    <option value="associate" {{ old('education_level', $jobPost->education_level) === 'associate' ? 'selected' : '' }}>Cao đẳng</option>
                                    <option value="bachelor" {{ old('education_level', $jobPost->education_level) === 'bachelor' ? 'selected' : '' }}>Đại học</option>
                                    <option value="master" {{ old('education_level', $jobPost->education_level) === 'master' ? 'selected' : '' }}>Thạc sĩ</option>
                                    <option value="phd" {{ old('education_level', $jobPost->education_level) === 'phd' ? 'selected' : '' }}>Tiến sĩ</option>
                                    <option value="any" {{ old('education_level', $jobPost->education_level) === 'any' ? 'selected' : '' }}>Không giới hạn</option>
                                </select>
                            </div>
                            <div class="form-control">
                                <label class="label py-0 pb-1.5">
                                ...
                                <input type="text" name="education_field" value="{{ old('education_field', $jobPost->education_field) }}"
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="certifications_required" rows="2"
                                      class="textarea textarea-bordered textarea-sm w-full">{{ old('certifications_required', $jobPost->certifications_required) }}</textarea>
                        </div>
        ...
        <div class="xl:sticky xl:top-4 space-y-4">
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body p-4">
                    <p class="text-xs font-semibold text-base-content/40 uppercase tracking-wide mb-3">Lưu thay đổi</p>
                    <div class="flex gap-2">
                        <a href="{{ route('backend.job-posts.show', $jobPost) }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
                    ...
                    <div class="divider my-2 text-xs text-base-content/30">Thông tin</div>
                    <dl class="space-y-1 text-xs text-base-content/50">
                        <div class="flex justify-between gap-2">
                            <dt>Tạo lúc</dt>
                            <dd class="font-medium text-base-content/70">{{ $jobPost->created_at->format('d/m/Y H:i') }}</dd>
                        </div>
                        <div class="flex justify-between gap-2">
                            <dt>Cập nhật</dt>
                            <dd class="font-medium text-base-content/70">{{ $jobPost->updated_at->format('d/m/Y H:i') }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="province" value="{{ old('province', $jobPost->province ?? '') }}"
