...
@section('title', $businessProject->name.' — Diagnosis')
...
<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div class="lg:col-span-2 space-y-4">
            @include('businessproject::business-projects.diagnosis._report', ['businessProject' => $businessProject, 'diagnosisReport' => $diagnosisReport])
            @include('businessproject::business-projects.diagnosis._matrix', [
            ...
            @include('businessproject::business-projects.diagnosis._evidence', [
                'businessProject' => $businessProject,
                'diagnosisReport' => $diagnosisReport,
