...
@section('title', $businessProject->name.' — Discovery')
...
<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div class="lg:col-span-2 space-y-4">
            @include('businessproject::business-projects.discovery._tps_canvas', ['businessProject' => $businessProject, 'tpsCanvas' => $tpsCanvas])
            @include('businessproject::business-projects.discovery._records', ['businessProject' => $businessProject, 'report' => $report, 'recordTypes' => $recordTypes])
            @include('businessproject::business-projects.discovery._report', ['businessProject' => $businessProject, 'report' => $report])
        </div>
        ...
        <div class="space-y-4">
            ...
            @include('businessproject::business-projects.discovery._industry_knowledge', [
