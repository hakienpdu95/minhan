...
@section('title', $businessProject->name.' — Customer Success')
...
<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div class="lg:col-span-2 space-y-4">
            @include('businessproject::business-projects.customer-success._csat_nps', [
                'businessProject' => $businessProject,
                'csatNpsSurvey' => $csatNpsSurvey,
                'attachableSurveyResponses' => $attachableSurveyResponses,
            ])
            @include('businessproject::business-projects.customer-success._follow_up_renewal', ['businessProject' => $businessProject])
            @include('businessproject::business-projects.customer-success._new_opportunity', ['businessProject' => $businessProject])
            @include('businessproject::business-projects.customer-success._reviews', [
                'businessProject' => $businessProject,
