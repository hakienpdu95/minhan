...
return new class extends Migration
{
    ...
    {
        Schema::create('mkt_applicants', function (Blueprint $table): void {
            $table->id();
        ...
        DB::statement('CREATE UNIQUE INDEX idx_mkt_appl_email ON mkt_applicants(email)');
        DB::statement('CREATE UNIQUE INDEX idx_mkt_appl_slug ON mkt_applicants(slug)');
        DB::statement('CREATE INDEX idx_mkt_appl_status ON mkt_applicants(status, availability)');
    }
