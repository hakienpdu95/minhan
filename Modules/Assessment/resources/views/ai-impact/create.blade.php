...
<div x-data="aiImpactForm()" class="max-w-2xl">
    <div class="card bg-base-100 shadow-sm border border-base-200">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('backend.ai-impact.store') }}" id="ai-impact-form">
                @csrf
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control">
                        ...
                        <select id="ts-impact_category" name="impact_category" class="ts-init w-full" data-req required>
                            <option value=""></option>
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" id="impact_type" name="impact_type"
                               ...
                               data-req required
                               placeholder="VD: Thời gian xử lý email, Số ticket/ngày...">
                        @error('impact_type')
                        <label class="label py-0.5"><span class="label-text-alt text-error text-xs">{{ $message }}</span></label>
                        @enderror
                    </div>
