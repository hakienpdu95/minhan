...
@section('title', 'Sửa nhiệm vụ: ' . $task->title)
...
<div class="flex items-center justify-between gap-3 mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Sửa nhiệm vụ</h1>
...
<form method="POST" action="{{ route('backend.sandbox-admin.task.update', $task) }}"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <textarea id="expected_output" name="expected_output" rows="3"
                                      ...
                                      placeholder="VD: Email 150-200 từ, tiêu đề rõ ràng, nội dung chuyên nghiệp lịch sự...">{{ old('expected_output', $task->expected_output) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" id="time_limit_minutes" name="time_limit_minutes" min="5" max="180"
                                   ...
                                   value="{{ old('time_limit_minutes', $task->time_limit_minutes) }}">
                            <label class="label py-0.5">
                        ...
                        <div class="form-control sm:col-span-2">
                            ...
                            <input type="text" id="ai_tools_allowed" name="ai_tools_allowed"
                                   ...
                                   value="{{ old('ai_tools_allowed', $task->ai_tools_allowed) }}"
                ...
                <div class="card-body p-4 space-y-4">
                    ...
                    <label class="flex items-start gap-2.5 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1"
                               ...
                               {{ old('is_active', $task->is_active ? '1' : '') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="border-t border-base-200 pt-3 space-y-1 text-xs text-base-content/40">
                        <p>Tạo: {{ $task->created_at?->format('d/m/Y H:i') }}</p>
                        <p>Cập nhật: {{ $task->updated_at?->format('d/m/Y H:i') }}</p>
                    </div>

                    <div class="border-t border-base-200 pt-4 flex flex-col gap-2">
                        <button type="submit" class="btn btn-primary btn-sm w-full">Cập nhật nhiệm vụ</button>
